const translations = {
    en: {
        ...
        privacy_s5_t: "5. Children's Privacy",
        privacy_s5_c: "The Service is not directed to children under 13, and we do not knowingly collect personal information from children under 13.<br><br>Users aged 13–18 (or the age of majority in their jurisdiction) may use the Service only with the consent and supervision of a parent or legal guardian. We may request verification of parental consent where required by law.<br><br>If you believe we have collected data from a child under 13 without parental consent, please contact us and we will delete it.",
        privacy_s6_t: "6. Data Security",
        privacy_s6_c: "We use technical and organizational measures designed to protect your personal information. However, no method of transmission over the Internet or electronic storage is 100% secure. While we strive to protect your data, we cannot guarantee absolute security.",
    ...
    tr: {
        ...
        privacy_s5_t: "5. Çocukların Gizliliği",
        privacy_s5_c: "Hizmet 13 yaşın altındaki çocuklara yönelik değildir ve bilerek 13 yaşın altındaki çocuklardan kişisel bilgi toplamayız.<br><br>13–18 yaş arası kullanıcılar (veya yargı bölgesinde reşit olma yaşı), Hizmeti yalnızca bir ebeveyn veya vasinin rızası ve gözetimi altında kullanabilir. Yasal olarak gerekli olduğunda ebeveyn rızasının doğrulanmasını talep edebiliriz.<br><br>13 yaşın altındaki bir çocuktan ebeveyn rızası olmadan veri topladığımıza inanıyorsanız lütfen bizimle iletişime geçin; verileri sileriz.",
        privacy_s6_t: "6. Veri Güvenliği",
        privacy_s6_c: "Kişisel bilgilerinizi korumak için teknik ve idari önlemler uyguluyoruz. Ancak İnternet üzerinden iletimin veya elektronik depolamanın yüzde yüz güvenli olmadığını unutmayın. Verilerinizi korumak için çaba göstersek de mutlak güvenliği garanti edemeyiz.",
    ...
    de: {
        ...
        privacy_s5_t: "5. Datenschutz für Kinder",
        privacy_s5_c: "Der Dienst richtet sich nicht an Kinder unter 13 Jahren, und wir erheben wissentlich keine personenbezogenen Daten von Kindern unter 13 Jahren.<br><br>Nutzer im Alter von 13 bis 18 Jahren (oder dem in ihrer Rechtsordnung geltenden Volljährigkeitsalter) dürfen den Dienst nur mit Einwilligung und Aufsicht eines Erziehungsberechtigten oder gesetzlichen Vertreters nutzen. Wo gesetzlich vorgeschrieben, können wir einen Nachweis der elterlichen Einwilligung verlangen.<br><br>Wenn Sie glauben, dass wir ohne elterliche Einwilligung Daten von einem Kind unter 13 Jahren erhoben haben, kontaktieren Sie uns bitte; wir werden die Daten löschen.",
        privacy_s6_t: "6. Datensicherheit",
        privacy_s6_c: "Wir setzen technische und organisatorische Maßnahmen ein, um Ihre personenbezogenen Daten zu schützen. Dennoch ist keine Übertragungsmethode über das Internet oder elektronische Speicherung zu 100 % sicher. Obwohl wir uns bemühen, Ihre Daten zu schützen, können wir absolute Sicherheit nicht garantieren.",
