...
private fun TermsTR() {
    ...
    LegalParagraph("Araba gorselleri Hot Wheels Wiki, Matchbox Wiki, Mini GT Wiki ve Majorette Wiki kaynaklarindan alinmaktadir. Bu gorseller ilgili wiki topluluklarina aittir ve yalnizca bilgilendirme amacli kullanilmaktadir.")
...
private fun TermsEN() {
    ...
    LegalParagraph("Car images are sourced from Hot Wheels Wiki, Matchbox Wiki, Mini GT Wiki, and Majorette Wiki. These images belong to their respective wiki communities and are used for informational purposes only.")
...
private fun TermsDE() {
    ...
    LegalParagraph("Fahrzeugbilder stammen aus Hot Wheels Wiki, Matchbox Wiki, Mini GT Wiki und Majorette Wiki. Diese Bilder gehoeren den jeweiligen Wiki-Gemeinschaften und werden nur zu Informationszwecken verwendet.")
