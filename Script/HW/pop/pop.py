...
def scrape_2026_pop_culture():
    base_api_url = "https://hotwheels.fandom.com/api.php"
    page_title = "2026_Pop_Culture"
    all_data = []
    ...
    try:
        ...
        for table in tables:
            # Seri adını Mix başlığından al (Örn: Mix 1 - Disney, Mix 2 vb.)
            series_name = "Pop Culture"
            ...
            # SÜTUN HARİTALAMA (Önceki düzeltmeler dahil)
            col_map = {}
            ...
            for row in rows[1:]:
                ...
                # 1/5 gibi değerlerin col_num yerine series_num'a gitmesi için kontrol
        ...
        if all_data:
            ...
            output_file = "hotwheels_2026_pop_culture.csv"
